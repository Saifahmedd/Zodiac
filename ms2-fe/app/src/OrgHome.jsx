...
const DonatedPosts = () =>{
    ...
    return (
        <div>
                ...
                <Card key={index} sx={{ maxWidth: 345, marginBottom: 2, marginLeft: 8 }}>
                  ...
                  <CardContent>
                    <Typography variant="body2" color="black">
                      Saif Ahmed Donated 2 Tshirts
                    </Typography>
                  </CardContent>
                  <CardActions disableSpacing>
                    <IconButton aria-label="view" onClick={() => handleViewClothesDetails(index)}>
                      <VisibilityIcon />
                    </IconButton>
          ...
          <ClothesDialog
            open={selectedClothesIndex !== null}
            handleClose={handleCloseClothesDetails}
