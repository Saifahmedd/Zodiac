...
const Post = ({ addPost }) => {
  ...
  const [showSchoolSuppliesSelect, setShowSchoolSuppliesSelect] =
    useState(false); // State to manage the visibility of the school supplies select component
  ...
  const [showMedicalSuppliesTextboxes, setShowMedicalSuppliesTextboxes] =
    useState(false);
  ...
  const [showSchoolSuppliesTextboxes, setShowSchoolSuppliesTextboxes] =
    useState(false);
  const [showStationaryTextboxes, setShowStationaryTextboxes] = useState(false);
  const [showBloodDonationsTextboxes, setShowBloodDonationsTextboxes] =
    useState(false);
  ...
  const [showMedicalCasesTextboxes, setShowMedicalCasesTextboxes] =
    useState(false);
    ...
    <div>
      ...
      <div>
        <Box sx={{ marginTop: 2 }}>
          <FormControl sx={{ minWidth: 220 }}>
            ...
            >
              ...
              <MenuItem
                value="Clothes"
                onClick={() => handleCategoryChange2("Clothes")}
              >
                Clothes
              </MenuItem>
              <MenuItem
                value="Toys"
                onClick={() => handleCategoryChange2("toys")}
              >
                Toys
              </MenuItem>
              <MenuItem
                value="Food"
                onClick={() => handleCategoryChange2("food")}
              >
                Food
              </MenuItem>
              <MenuItem
                value="Medical Supplies"
                onClick={() => handleCategoryChange2("medicalSupplies")}
              >
                Medical Supplies
              </MenuItem>
              <MenuItem
                value="School Supplies"
                onClick={() => handleCategoryChange2("schoolSupplies")}
              >
                School Supplies
              </MenuItem>
              <MenuItem
                value="Blood Donations"
                onClick={() => handleCategoryChange2("bloodDonation")}
              >
                Blood Donations
              </MenuItem>
              <MenuItem
                value="Teaching"
                onClick={() => handleCategoryChange2("teaching")}
              >
                Teaching
              </MenuItem>
              <MenuItem
                value="Medical Cases"
                onClick={() => handleCategoryChange2("medicalCases")}
              >
                Medical Cases
              </MenuItem>
            </Select>
        ...
        {showSchoolSuppliesSelect && (
          <Box sx={{ marginTop: 2 }}>
            <FormControl sx={{ minWidth: 220 }}>
              <InputLabel id="school-supply-label">
                Choose a School Supply
              </InputLabel>
              <Select
          ...
          <Box sx={{ marginTop: 2 }}>
            ...
            <FormControl sx={{ minWidth: 220 }}>
              ...
              <Select
                ...
                variant="standard"
              >
                {!age && <MenuItem value="" disabled></MenuItem>}
                ...
                <MenuItem value="12-14 years">12 - 14 years</MenuItem>
                <MenuItem value="14-16 years">14 - 16 years</MenuItem>
                <MenuItem value="16-18 years">16 - 18 years</MenuItem>
                <MenuItem value="18-20 years">18 - 20 years</MenuItem>
          ...
          <Box sx={{ marginTop: 2 }}>
            ...
            <FormControl sx={{ minWidth: 220 }}>
              ...
              >
                ...
                <MenuItem value="1-2 years">20+</MenuItem>
                {/* Add more age ranges as needed */}
              </Select>
            </FormControl>
            <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      {selectedCategory && (
        <Button onClick={() => handleSubmitButton(selectedCategory)}>
          Submit
        </Button>
      )}
      ...
      <Dialog open={isSubmitted} onClose={handleClose}>
        ...
        <DialogActions>
          <Button onClick={handleClose} component={Link} to="/">
            OK
          </Button>
        </DialogActions>
      </Dialog>
